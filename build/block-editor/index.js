...
/* harmony import */ var _neon_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./neon.scss */ "./src/block-editor/neon.scss");
...
(0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_2__.registerFormatType)("bwd-plus/neon", {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Neon", "bwd-plus"),
  tagName: "span",
  className: "neon",
  edit({
    isActive,
    ...
    const selectBlock = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => select("core/block-editor").getSelectedBlock());
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, selectBlock?.name === "core/paragraph" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.RichTextToolbarButton, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Neon", "bwd-plus"),
      icon: "superhero",
      isActive: isActive,
      onClick: () => {
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_1__.registerPlugin)('bwd-plus-sidebar', {
  render() {
    const {
      og_title,
      og_description,
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_edit_post__WEBPACK_IMPORTED_MODULE_2__.PluginSidebar, {
      ...
      icon: "share",
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('BWD Plus Sidebar', 'bwd-plus')
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Opengraph Options", "bwd-plus")
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.TextControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Title", "bwd-plus"),
      value: og_title,
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Description", "bwd-plus"),
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Override Featured Image", "bwd-plus"),
      checked: og_override_image,
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("By default, the featured image will be used as the image. Check this option to use a different image.", "bwd-plus"),
      ...
      render: ({
        ...
        return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
          ...
          onClick: open
        }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Upload/Select Image", "bwd-plus"));
      },
      onSelect: image => {
        editPost({
          meta: {
